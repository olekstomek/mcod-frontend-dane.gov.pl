...
export class TooltipDirective implements OnInit {
    ...
    ngOnInit() {
        ...
        const flexibleConnectedPositionStrategy = this.overlay.position().flexibleConnectedTo(connectedElement)
    ...
    show(): void {
        ...
        const userProfilePortal = new ComponentPortal(TooltipWithTitleComponent, null, this.createInjector({
            title: this.title,
            text: this.text
        }));
