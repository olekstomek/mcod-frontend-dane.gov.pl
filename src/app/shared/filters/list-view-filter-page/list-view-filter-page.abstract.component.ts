...
export abstract class ListViewFilterPageAbstractComponent {
     ...
     */
    backupSelectedFilters: IListViewDatasetFiltersModel | IListViewInstitutionFiltersModel | IListViewInstitutionItemFiltersModel | IListViewInstitutionItemCategoryFiltersModel;

    /**
     * Selected filters
     */
    selectedFilters: IListViewDatasetFiltersModel | IListViewInstitutionFiltersModel | IListViewInstitutionItemFiltersModel | IListViewInstitutionItemCategoryFiltersModel;
    ...
    constructor(protected filterService: ListViewFiltersService, protected activatedRoute: ActivatedRoute,
    ...
    clearSelectedFilter(filter: SelectedFilter) {
        const updatedQueryParams: PageParams = this.selectedFiltersService.removeSelectedFilter(filter,
            this.activatedRoute.snapshot.queryParams, this.backupSelectedFilters);
    ...
    protected setSelectedFilters(queryParams: PageParams) {
        const newSelectedFilters = this.filterService.setSelectedFilters(queryParams, this.DateFields, this.filters,
            this.selectedFilters, this.params);
