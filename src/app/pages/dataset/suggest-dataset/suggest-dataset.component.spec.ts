...
describe('SuggestDatasetComponent', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      declarations: [SuggestDatasetComponent, MathCaptchaComponent, NotificationsComponent, NotificationsServerComponent],
      imports: [
      ...
      providers: [{ provide: DatasetService, useClass: DatasetService }, NotificationsService, SeoService],
    });
