...
export class ListViewSelectedFilterService {
     ...
     * @return {PageParams}
     */
    removeSelectedFilter({ names, key, isDate }: SelectedFilter, queryParams: PageParams,
                         selectedIds: IListViewDatasetFiltersModel | IListViewInstitutionFiltersModel |
                             IListViewInstitutionItemFiltersModel | IListViewInstitutionItemCategoryFiltersModel): PageParams {
