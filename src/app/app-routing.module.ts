...
const routes: Routes = [
    {
        path: '!embed', loadChildren: () => import('./pages/embedded/embedded.module').then(m => m.EmbeddedModule)
    },
    {
        path: '',
        component: MainLayoutComponent, children: [
            ...
            {
                path: '!promotion', component: CmsLandingPageComponent, children: [
                    {
                        path: '**',
            ...
            {
                path: '!page', component: PreviewCmsComponent, children: [
                    {
                        path: '**',
