...
export class TourButtonComponent implements OnInit, OnDestroy {
     ...
     * @ignore
     */
    constructor(@Optional() private readonly tourDataService: TourDataService,
    ...
    ngOnInit(): void {
        ...
        this.tourService.getButtonVisibilityForCurrentRoute()
        ...
        this.tourService.isButtonActive
            .pipe(takeUntil(this.destroy$))
