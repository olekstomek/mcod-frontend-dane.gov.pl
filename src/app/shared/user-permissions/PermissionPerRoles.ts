...
export class PermissionPerRoles {
    ...
    */
    static readonly BROWSE_DASHBOARD = [Role.LOGGED_IN, Role.OFFICIAL, Role.EDITOR, Role.ADMIN_AOD, Role.ADMIN_LOD, Role.PORTAL_ADMIN, Role.ADMIN];
    ...
    */
    static readonly BROWSE_AOD = [Role.OFFICIAL, Role.EDITOR, Role.ADMIN_AOD, Role.ADMIN_LOD, Role.PORTAL_ADMIN, Role.ADMIN, Role.REPRESENTATIVE];
    ...
    */
    static readonly MANAGE_OBSERVERS = [Role.LOGGED_IN, Role.OFFICIAL, Role.EDITOR, Role.ADMIN_AOD, Role.ADMIN_LOD, Role.PORTAL_ADMIN, Role.ADMIN];

    /*
     User is allowed to change password
    */
    static readonly CHANGE_PASSWORD = [Role.LOGGED_IN, Role.OFFICIAL, Role.EDITOR, Role.ADMIN_AOD, Role.ADMIN_LOD, Role.PORTAL_ADMIN, Role.ADMIN];
    ...
    */
    static readonly SET_NOTIFICATION_AS_READ = [Role.LOGGED_IN, Role.OFFICIAL, Role.EDITOR, Role.ADMIN_AOD, Role.ADMIN_LOD, Role.PORTAL_ADMIN, Role.ADMIN];

    /*
     User is allowed to view search history
    */
    static readonly VIEW_SEARCH_RESULT_HISTORY = [Role.LOGGED_IN, Role.OFFICIAL, Role.EDITOR, Role.ADMIN_AOD, Role.ADMIN_LOD, Role.PORTAL_ADMIN, Role.ADMIN];

    /*
     User is allowed to manage email notifications
    */
    static readonly MANAGE_EMAIL_NOTIFICATIONS = [Role.LOGGED_IN, Role.OFFICIAL, Role.EDITOR, Role.ADMIN_AOD, Role.ADMIN_LOD, Role.PORTAL_ADMIN, Role.ADMIN];

    /*
     User is allowed to manage observers of datasets
    */
    static readonly MANAGE_DATASET_OBSERVERS = [Role.LOGGED_IN, Role.OFFICIAL, Role.EDITOR, Role.ADMIN_AOD, Role.ADMIN_LOD, Role.PORTAL_ADMIN, Role.ADMIN];

    /*
     User is allowed to manage observers of search result
    */
    static readonly MANAGE_SEARCH_RESULT_OBSERVERS = [Role.LOGGED_IN, Role.OFFICIAL, Role.EDITOR, Role.ADMIN_AOD, Role.ADMIN_LOD, Role.PORTAL_ADMIN, Role.ADMIN];
