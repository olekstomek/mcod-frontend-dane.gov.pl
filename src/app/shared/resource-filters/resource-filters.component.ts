...
export class ResourceFiltersComponent implements OnInit {
    ...
    */
    ...
    getOperatorsByDataType(dataType: ResourceDataType): ResourceFilterOperator[] {
        const topOperators = [
            ResourceFilterOperator.isEqual,
            ResourceFilterOperator.isNotEqual
        ];
        const bottomOperators = [
            ResourceFilterOperator.isEmpty,
            ResourceFilterOperator.isNotEmpty
        ];
        const glOperators = [
            ResourceFilterOperator.isGreaterThan,
            ResourceFilterOperator.isLessThan
        ];
        const glOrOperators = [
            ResourceFilterOperator.isGreaterOrEqual,
            ResourceFilterOperator.isLessOrEqual
        ];
